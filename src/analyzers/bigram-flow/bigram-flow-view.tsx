...
export function BigramFlowView({
  ...
  const toggleFinger = (finger: FingerClass) => {
    ...
    onConfigChange({ ...config, selectedFingers: nextSelectedFingers });
  };
      ...
      <section className="flow-controls" aria-label="Bigram Flow controls">
          ...
          <div className="flow-segmented" role="group" aria-label="bigram source">
            {(['actual', 'within-hand'] as const).map((candidate) => (
              <button
                ...
                onClick={() => onConfigChange({ ...config, source: candidate })}
              >
        ...
        <label className="flow-control-group">
          ...
          <select
            ...
            value={lineScale}
            onChange={(event) => onConfigChange({ ...config, lineScale: event.currentTarget.value as KeyboardFlowWeightScale })}
          >
        ...
        <label className="flow-control-group">
          ...
          <select
            aria-label="紐の重ね順"
            value={layerOrder}
            onChange={(event) => onConfigChange({ ...config, layerOrder: event.currentTarget.value as KeyboardFlowLayerOrder })}
          >
        ...
        <label className="flow-control-group flow-checkbox-row">
          <input
            ...
            onChange={(event) => onConfigChange({ ...config, hoverScale: event.currentTarget.checked ? 'key' : 'global' })}
          />
            ...
            <div className="flow-profile-controls" aria-label="Movement profile controls">
              <label>
                ...
                <select
                  ...
                  onChange={(event) => onConfigChange({ ...config, movementScaleMode: event.currentTarget.value as MovementScaleMode })}
                >
              ...
              <label>
                ...
                <input
                  ...
                  aria-label="方向の広がり"
                  onChange={(event) => onConfigChange({ ...config, polarBandwidth: Number(event.currentTarget.value) })}
                />
              </label>
              <label>
                ...
                <input
                  ...
                  onChange={(event) => onConfigChange({ ...config, polarGain: Number(event.currentTarget.value) })}
                />
              </label>
              <button
                type="button"
