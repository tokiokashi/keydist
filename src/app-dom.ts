...
export const el = {
  ...
  geometryModalEditor: $<HTMLDivElement>('geometry-modal-editor'),
  geometryModalUnit: $<HTMLSelectElement>('geometry-modal-unit'),
  geometryModalName: $<HTMLInputElement>('geometry-modal-name'),
  geometryModalSave: $<HTMLButtonElement>('geometry-modal-save'),
  geometryModalSaveAs: $<HTMLButtonElement>('geometry-modal-save-as'),
  geometryModalDelete: $<HTMLButtonElement>('geometry-modal-delete'),
  geometryModalError: $<HTMLParagraphElement>('geometry-modal-error'),
