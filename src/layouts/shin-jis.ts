...
/**
 * 新 JIS の登録枠（#24）。かなの配置は #24 の出典から埋める。
...
export const SHIN_JIS_PREFIX = makeLayout('shin-jis-prefix', '新 JIS（逐次シフト）', 'prefix');
export const SHIN_JIS_SIMULTANEOUS = makeLayout('shin-jis-simultaneous', '新 JIS（通常シフト）', 'simultaneous');
